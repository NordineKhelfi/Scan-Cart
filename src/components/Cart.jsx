...
export default function Cart({ items, onRemoveItem, onFinishTrip }) {
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ width: '100%', display: 'flex', justifyContent: 'center', padding: '0.75rem 0', cursor: 'grab' }}>
          <div style={{ width: '40px', height: '5px', backgroundColor: 'var(--text-secondary)', borderRadius: '3px', opacity: 0.5 }} />
        </div>
